...
const { parseError } = require("../services/util");
...
userRouter.post(
    ...
    body("password").trim().isAlphanumeric().isLength({ min: 6 }).withMessage("Password must be at least 6 charecters long and may contain only English letters and numbers"),
