...
function updateCache(target, methodName, descriptor) {
    let cache = [];
    let lastUpdated = null;
    const originalMethod = descriptor.value;
    descriptor.value = function () {
        let curretMoment = new Date();
        if (!lastUpdated || (curretMoment.getTime() - lastUpdated.getTime()) > 5000) {
...
//# sourceMappingURL=05.%20WeatherData.js.map