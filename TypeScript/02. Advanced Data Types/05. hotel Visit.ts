type TypeGym = { number: 1, train: () => void } & ({ hallway: "A", pass?: "Guest" } | { hallway: "C" });
type TypeRestourant = { number: 2, dine: () => void } & ({ hallway: "A", pass?: "Guest" } | { hallway: "C" });
type TypeHotel = { number: 3, sleep: () => void, hallway: 'A' | 'C' };
type simplified = TypeGym | TypeRestourant | TypeHotel;
